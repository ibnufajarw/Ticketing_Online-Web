                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <small class="text-muted">Format: JPG,JPEG,PNG | Maks: 2Mb @if (isset($acara) && $acara->thumbnail)
                                    | <a href="{{ Storage::disk('local')->url($acara->thumbnail) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input placeholder="Dalam menit" type="number" min="1"
                                    ...
                                    value="{{ $acara->durasi_menit_estimasi }}" required>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control" name="peraturan" id="peraturan">{{ isset($acara) ? $acara->peraturan : $acara->peraturan }}</textarea>
                        </div>
                        <div class="form-group">
                            <label for="keterangan">Keterangan</label>
                            <textarea rows="5" class="form-control" name="keterangan" id="keterangan">{{ isset($acara) ? $acara->keterangan : $acara->keterangan }}</textarea>
                        </div>
                    </div>
