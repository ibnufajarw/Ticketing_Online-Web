                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kontak') is-invalid @enderror" name="kontak"
                                id="kontak" value="{{ old('kontak') }}" required>
                            @error('kontak')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                            <label for="social_media">Social Media Panitia <span class="text-danger">*</span></label>
                            <textarea rows="10" class="form-control" name="social_media" id="social_media" required>{{ old('social_media') }}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="10" class="form-control" name="deskripsi" id="deskripsi" required>{{ old('deskripsi') }}</textarea>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input type="datetime-local" class="form-control @error('waktu_selesai') is-invalid @enderror"
                                    name="waktu_selesai" id="waktu_selesai" value="{{ old('waktu_selesai') }}" required>
                                @error('waktu_selesai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control" name="peraturan" id="peraturan" required>{{ isset($acara) ? $acara->peraturan : old('peraturan') }}</textarea>
                        </div>
                    </div>
