...
class AcaraSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('acara')->insert([
            ...
            'waktu_selesai' => Carbon::now()->addDays(7)->addHours(5),
        ...
        DB::table('acara')->insert([
            ...
            'waktu_selesai' => Carbon::now()->addDays(8)->addHours(5),
        ...
        DB::table('acara')->insert([
            ...
            'waktu_selesai' => Carbon::now()->addDays(14)->addHours(5),
        ...
        DB::table('acara')->insert([
            ...
            'waktu_selesai' => Carbon::now()->addDays(21)->addHours(5),
        ...
        DB::table('acara')->insert([
            ...
            'waktu_selesai' => Carbon::now()->addDays(15)->addHours(5),
        ...
        DB::table('acara')->insert([
            ...
            'waktu_selesai' => Carbon::now()->addDays(28)->addHours(5),
            // 'durasi_menit_estimasi' => 120,
